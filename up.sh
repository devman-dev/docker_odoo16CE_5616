...
git clone -b 18.0 --single-branch https://github.com/ingadhoc/odoo-argentina.git ./odoo-addons/ingadhoc/odoo-argentina 
git clone -b 18.0 --single-branch https://github.com/ingadhoc/account-payment.git ./odoo-addons/ingadhoc/account-payment 
git clone -b 18.0 --single-branch https://github.com/ingadhoc/account-invoicing.git ./odoo-addons/ingadhoc/account-invoicing 
git clone -b 18.0 --single-branch https://github.com/ingadhoc/argentina-sale.git ./odoo-addons/ingadhoc/argentina-sale 
git clone -b 18.0 --single-branch https://github.com/ingadhoc/miscellaneous.git ./odoo-addons/ingadhoc/miscellaneous 
git clone -b 18.0 --single-branch https://github.com/ingadhoc/stock.git ./odoo-addons/ingadhoc/stock 
git clone -b 18.0 --single-branch https://github.com/ingadhoc/account-financial-tools.git ./odoo-addons/ingadhoc/account-financial-tools 
git clone -b 18.0 --single-branch https://github.com/ingadhoc/odoo-argentina-ce.git ./odoo-addons/ingadhoc/odoo-argentina-ce
...
git clone -b 18.0 --single-branch https://github.com/OCA/stock-logistics-workflow.git ./odoo-addons/OCA/stock-logistics-workflow 
git clone -b 18.0 --single-branch https://github.com/OCA/sale-workflow.git ./odoo-addons/OCA/sale-workflow 
